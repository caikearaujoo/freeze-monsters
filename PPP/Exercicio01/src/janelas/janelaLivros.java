...
public class janelaLivros extends JFrame implements ActionListener {
    ...
    JLabel labelTipo = new JLabel("Tipo(Escreva livro):");
    ...
    public janelaLivros() {
        ...
        btnRevistas.setBounds(350, 250, 100, 30);
        ...
        this.add(btnIncluir);
        this.add(btnListar);
        this.add(btnRevistas);

        // Adicionando ActionListener aos botões
        btnIncluir.addActionListener(this);
        btnListar.addActionListener(this);
        btnRevistas.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } else if (source.getText().equals("Revistas")) {
            this.dispose();
            new janelaRevistas();
