...
public class Gosma extends BadSprite {
    ...
    private void initGosma(int x, int y, int i) {
        ...
        setDestroyed(true); //A gosma é criada inicialmente como "destruída" (destroyed = true). Quando o monstro decide atirar, ele "reativa" a gosma com setDestroyed(false)
        ...
        Image gosmaImage = ii.getImage().getScaledInstance(15, 15, Image.SCALE_DEFAULT); //puro redimensionamento da imagem
        setImage(gosmaImage);
